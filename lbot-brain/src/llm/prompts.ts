...
export function buildPlannerMessages(input: {
  ...
  const systemPrompt = [
    ...
    '- vision.describe para pedidos de observacao, descricao, analise visual, busca por objetos e perguntas sobre o que a camera mostra.',
    ...
    "Se a intencao for claramente sobre ver, procurar, contar, descrever ou analisar algo visivel, use vision.describe.",

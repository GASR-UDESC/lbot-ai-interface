...
- [x] Tarefa 1: Redesenhar Nivel 1 (Armazem) - Desvio lateral simples
...
- [x] Tarefa 2: Redesenhar Nivel 2 (Escritorio) - Desvio lateral com mais paredes
  - Arquivo: `lbot-datagen/lbot-datagen-frontend/src/app/models/level-config.model.ts`
...
- [x] Tarefa 3: Redesenhar Nivel 3 (Cidade) - Corredores com curvas
  - Arquivo: `lbot-datagen/lbot-datagen-frontend/src/app/models/level-config.model.ts`
...
- [x] Tarefa 4: Redesenhar Nivel 4 (Floresta) - Labirinto
  - Arquivo: `lbot-datagen/lbot-datagen-frontend/src/app/models/level-config.model.ts`
...
- [x] Tarefa 5: Redesenhar Nivel 5 (Fabrica) - Labirinto + Rampas obrigatorias
  - Arquivo: `lbot-datagen/lbot-datagen-frontend/src/app/models/level-config.model.ts`
...
- [x] Tarefa 6: Remover botao "Novo Desafio" e metodo generateNewLevel()
...
- [x] Tarefa 7: Remover estilos do botao "Novo Desafio"
...
- [x] CA04: Botao "Novo Desafio" nao existe na interface
...
- [x] CA05: Pontos A e B sao fixos por nivel (definidos em LevelConfig)
...
- Testes executados:
  ...
  - Verificacao manual via browser em `http://127.0.0.1:4200/game` - nivel 1 abriu com pontos fixos e sem botao `Novo Desafio`
- Resultado: Implementacao concluida e compilando, com remocao do fluxo aleatorio de desafios e redesign inicial dos 5 niveis.
- Pendencias:
  - Validar manualmente que todos os 5 niveis sao completaveis e que o nivel 1 bloqueia percurso reto em runtime.

...
- [ ] Tarefa 1: Corrigir escala da arena no headless renderer
...
- [ ] Tarefa 2: Adicionar objetos na cena headless
  - Arquivo: `3.controlador/lbot-simulator-web/server/scene-renderer.ts`
...
- [ ] Tarefa 3: Atualizar sensores para detectar objetos via AABB
...
- [ ] Tarefa 4: Adicionar testes para sensores detectando objetos
...
- [ ] Tarefa 5: Adicionar teste de integracao para cena headless
...
- [ ] Tarefa 6: Verificar fallback 2D sem objetos
  - Arquivo: `3.controlador/lbot-simulator-web/server/scene-renderer.ts`
...
- [ ] CA01 - Camera mostra objetos na imagem
...
- [ ] CA03 - Sensor de proximidade detecta objeto a frente
...
- [ ] CA-SCALE-01 - Escala da arena headless alinhada com frontend

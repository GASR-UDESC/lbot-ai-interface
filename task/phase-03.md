...
- [x] Tarefa 1: Implementar tool `camera`
  - Arquivo: `3.controlador/lbot-mcp/src/mcp_server/tools/camera.py` (novo)
  - O que fazer:
...
- [x] Tarefa 2: Implementar tool `proximity`
  - Arquivo: `3.controlador/lbot-mcp/src/mcp_server/tools/proximity.py` (novo)
  - O que fazer:
...
- [x] Tarefa 3: Implementar tool `move`
  - Arquivo: `3.controlador/lbot-mcp/src/mcp_server/tools/movement.py` (novo)
  - O que fazer:
...
- [x] Tarefa 4: Registrar tools no servidor FastMCP e configurar injeção de backend
  - Arquivo: `3.controlador/lbot-mcp/src/mcp_server/server.py` (alterar)
  - O que fazer:
    ...
    - Criar `3.controlador/lbot-mcp/src/mcp_server/context.py` (novo) com:
...
- `3.controlador/lbot-mcp/src/mcp_server/server.py` — FastMCP app, configuração de backend (criado na Fase 02)
- `3.controlador/lbot-mcp/src/mcp_server/backends/base.py` — Interface `LBotBackend` com os métodos que as tools chamam
- `3.controlador/lbot-mcp/src/mcp_server/backends/simulator.py` — Implementação HTTP para simulador
- `3.controlador/lbot-mcp/src/mcp_server/translator/__init__.py` — `TranslatorWrapper` (criado na Fase 02)
- `3.controlador/lbot-simulator-web/shared/lbml.ts` — Formato LBML: regex `^(D\d+[FBLR];|R\d+[LR];)+$`
- `2.treinamento-de-modelo/lbot-natural-language-controller/lbot-v7/lbot_v7.py` — `LBotTranslatorV7.translate()`, `translate_verbose()`
...
```bash
cd 3.controlador/lbot-mcp && python -c "
from mcp_server.server import mcp
print('Tools registradas:', len(mcp._tools))
"
cd 3.controlador/lbot-mcp && python -m mcp_server.server &
...
- Data: 2026-06-02
- Arquivos criados:
  - `3.controlador/lbot-mcp/src/mcp_server/tools/camera.py` — Tool MCP de câmera (captura imagem base64 via backend)
  - `3.controlador/lbot-mcp/src/mcp_server/tools/proximity.py` — Tool MCP de sensor de proximidade (leituras formatadas em pt-BR)
  - `3.controlador/lbot-mcp/src/mcp_server/tools/movement.py` — Tool MCP de deslocamento (NL → LBML → execução)
  - `3.controlador/lbot-mcp/src/mcp_server/context.py` — Módulo de injeção de dependências (backend singleton + translator lazy)
- Arquivos alterados:
  - `3.controlador/lbot-mcp/src/mcp_server/server.py` — Adicionado setup de contexto e import/registro das 3 tools no `main()`
- Testes executados:

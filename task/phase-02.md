...
- [x] Tarefa 1: Incluir arena walls na checagem de isValidPosition()
...
- [x] Tarefa 2: Aumentar altura das arena walls para 30 unidades
  - Arquivo: `lbot-datagen/lbot-datagen-frontend/src/app/services/physics.service.ts`
...
- [x] Tarefa 3: Aumentar altura visual das arena walls
...
- [x] Tarefa 4: Garantir que colisao para o robot sem bounce
  - Arquivo: `lbot-datagen/lbot-datagen-frontend/src/app/services/physics.service.ts`
...
- [x] Tarefa 5: Ajustar getMaxValidPosition para stepSize menor
  - Arquivo: `lbot-datagen/lbot-datagen-frontend/src/app/services/physics.service.ts`
...
- [x] CA03: Robot nao atravessa parede perimetral
...
- [x] CA03-b: Accelerar contra barreira nao permite atravessar
...
- [x] CA03-c: Robot nao passa por baixo das paredes
...
- Testes executados:
  ...
  - Verificacao manual via browser em `http://127.0.0.1:4200/game` - comando `andar para frente 500` parou o robo em `z=183.6`, dentro do limite da arena
  - Verificacao manual via browser em `http://127.0.0.1:4200/game` - comando adicional `andar para frente 100` manteve o robo parado contra a parede, sem atravessar e sem `NaN`
- Resultado: Fisica da arena corrigida com limite consistente para o corpo do robo, arena walls com altura 30 no visual e na fisica, step do ray-march reduzido para 2, e parada imediata ao colidir. O fluxo do simulador passou a aplicar `getMaxValidPosition()` em runtime para bloquear movimentos antes da parede.
- Pendencias: nenhuma
